...
**Status:** COMPLETE — retroactive filing
**Approved by:** J — 2026-07-01. Human-Owned Stops wording in `BUILD-PLAN.md`
  ...
  simulator command/release is in scope for this lab. All acceptance checks
  verified (`py_compile`, `run-smoke-test.sh`, command/override/release API
  flow) prior to approval.
